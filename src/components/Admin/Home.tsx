...
<main className="h-auto pt-20 md:ml-64">
    ...
    <div className="p-4 mb-4 rounded-lg shadow-lg dark:border-gray-60" >
        <p className='text-5xl font-semibold text-center'>Welcome <span>Nithwin V M</span> !</p>
        <div className=''>
          <div className='mb-3 border-2 rounded-full shadow-lg bg-lightWhite h-28 w-28' />
