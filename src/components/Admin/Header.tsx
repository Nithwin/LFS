...
const Header = ({ toggleSidebar }:{toggleSidebar: () => void }) => {
  return (
      <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-darkPurple
...
<RiMenu2Fill className='text-white size-6 ms-1'/>
    </button>
    <a
  ...
  <div className="flex items-center lg:order-2">
   ...
   <Link to={'/admin/profile'} className='mx-2 '>
    ...
    <Link to={'/admin/profile'} className='mx-2 '>
      <CgProfile className='text-gray-400 size-6 hover:text-lightWhite '/>
    </Link>
...

{
  /*
  <div
      className="z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl"
...
{/* <div
      className="z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
      id="apps-dropdown"
    >
      <div className="block px-4 py-2 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-600 dark:text-gray-300">
        Apps
   ...
   {/* <div
      className="z-50 hidden w-56 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
      id="dropdown"
    >
        ...
        <li>
          ...
          >
            <span className="flex items-center">
              <svg
                aria-hidden="true"
                className="w-5 h-5 mr-2 text-primary-600 dark:text-primary-500"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
