...
const SideBar: React.FC<{ isOpen: boolean }> = ({ isOpen }) => {
  return (
    ...
    <div className="flex flex-col justify-between h-full px-3 py-5 overflow-y-auto bg-white dark:bg-darkPurple">
      ...
      <ul className="space-y-8 userSideBar">
        <li>
            <NavLink to={'/user/dashboard'} className="flex items-center p-2 ml-3 space-x-3 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-blue-700 dark:hover:bg-blue-700 group">
              <MdDashboard className='text-white size-5 color'/>
              <span>Dashboard</span>
            </NavLink>
        </li>
        ...
        <li>
          <NavLink to={'/user/task'} className="flex items-center p-2 ml-3 space-x-3 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-blue-700 dark:hover:bg-blue-700 group">
            <MdTaskAlt className='text-white size-5 color'/>
            <span>Tasks</span>
          </NavLink>
        </li>

        <li>
          <NavLink to={'/user/learn'} className="flex items-center p-2 ml-3 space-x-3 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-blue-700 dark:hover:bg-blue-700 group">
            <FaBookReader className='text-white size-5 color'/>
        ...
        <li>
          <NavLink to={'/user/faculty'} className="flex items-center p-2 ml-3 space-x-3 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-blue-700 dark:hover:bg-blue-700 group">
            <FaChalkboardTeacher className='text-white size-5 color'/>
            <span>Faculty</span>
          </NavLink>
        </li>
